...
import VerifyOtp from '../screens/LoginScreen/VerifyOtp';
import AutoOrder from '../screens/BottomNav/AutoOrder/AutoOrder';
import PreviousOrder from '../screens/BottomNav/PreviousOrder/PreviousOrder';
const SIZE = 80;
    ...
    <Tab.Navigator
      ...
      screenOptions={({route}) => ({
        tabBarIcon: ({focused, color, size}) => {
          ...
          let colorIcon = focused ? colors.THEME_ORANGE : colors.LIGHT_GREY; // 51b9db
        ...
        //     return <Icon name={iconName} size={sizeIcon} color={colorIcon} />/*color:0096C7*/
        // }
        else if (route.name === 'Add') {
            iconName = focused ? 'mountains' : 'mountains'
            return <Foundation name={iconName} size={sizeIcon} color={colorIcon} />
        } else if (route.name === 'Auto Order') {
      ...
      <Tab.Screen name="Auto Order" component={AutoOrder} />
